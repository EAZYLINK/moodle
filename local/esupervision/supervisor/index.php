...
$PAGE->navbar->add(get_string('dashboard', 'local_esupervision'), "$CFG->wwwroot/local/esupervision/supervisor/index.php");

echo $OUTPUT->header();

echo "<h2>Welcome to the Supervisor Dashboard!</h2>";
echo "<p>As a supervisor, you can manage projects and provide feedback to students here.</p>";
